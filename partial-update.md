...
We supported manually add class members, like field, method and constructor. We will keep the added member after codegen. Below are examples demonstrate how you add an additional field or method or constructor.
...
We supported manually update method, including update method signature, like parameter type/name change, method access level change, as well as update method body. Pleaes do remember to **remove** `@Generated` annotation when you do the update. We will keep your manual code change and not generate the corresponding method with the same method name as your updated function.
...
Unit test is in [PartialUpdateHandlerTest.java](https://github.com/Azure/autorest.java/blob/main/postprocessor/src/test/java/com/azure/autorest/postprocessor/util/PartialUpdateHandlerTest.java). it tests below cases:
...
https://github.com/Azure/autorest.java/blob/main/partial-update-tests/existing/src/main/java/fixtures/bodystring/StringOperationClient.java#L23-L24
https://github.com/Azure/autorest.java/blob/main/partial-update-tests/existing/src/main/java/fixtures/bodystring/StringOperationClient.java#L36-L39
https://github.com/Azure/autorest.java/blob/main/partial-update-tests/existing/src/main/java/fixtures/bodystring/StringOperationClient.java#L275

* Corresponding generated code: https://github.com/Azure/autorest.java/blob/main/partial-update-tests/generated/src/main/java/fixtures/bodystring/StringOperationClient.java

1. Manually update method signature - parameter change
* existing code change:
https://github.com/Azure/autorest.java/blob/main/partial-update-tests/existing/src/main/java/fixtures/bodystring/StringOperationClient.java#L60-L78
...
* swagger change:
Below api from bodystring.json is removed from bodystring_updated.json
https://github.com/Azure/autorest.java/blob/main/partial-update-tests/existing/swagger/specification/bodystring.json#L382-L406
